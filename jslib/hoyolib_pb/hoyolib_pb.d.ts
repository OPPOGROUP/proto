...
export class CheckinResults extends jspb.Message {
  ...
  getResultsList(): Array<CheckInResponse>;
  setResultsList(value: Array<CheckInResponse>): void;
  addResults(value?: CheckInResponse, index?: number): CheckInResponse;
...
export namespace CheckinResults {
  export type AsObject = {
    resultsList: Array<CheckInResponse.AsObject>,
  }
}
